<x-app-layout>
    ...
    <div class="py-12 bg-[#FDFBF7] min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            {{-- Error Message --}}
            @if(session('error'))
                <x-alert type="error" :message="session('error')" class="mb-8" />
            @endif
                                ...
                                <tr class="hover:bg-[#FDFBF7] transition duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end space-x-3">
                                            <a href="{{ route('faq.admin.categories.edit', $category) }}" class="text-[#8C7B70] hover:text-[#3E2C22] transition" title="Bewerken">
