                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="mt-auto">
                                ...
                                <div class="flex flex-col sm:flex-row gap-4">
                                    {{-- Toevoegen aan winkelwagen (Dummy knop voor nu) --}}
                                    <button
                                        @if($product->stock <= 0) disabled @endif
                                    class="flex-1 bg-gray-900 text-white px-8 py-3 rounded-md font-semibold hover:bg-gray-800 transition disabled:opacity-50 disabled:cursor-not-allowed text-center flex items-center justify-center"
                                    >
