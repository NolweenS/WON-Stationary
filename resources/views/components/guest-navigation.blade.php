                    ...
                    <div class="relative" x-data="{ userOpen: false }">
                        ...
                        <div x-show="userOpen" @click.away="userOpen = false" class="absolute right-0 mt-2 w-48 bg-white border border-border rounded-md shadow-lg py-1 z-50" style="display: none;">
                            @if(Auth::user()->isAdmin())
                                <a href="{{ route('admin.dashboard') }}" class="block px-4 py-2 text-sm text-secondary hover:bg-beige hover:text-primary">Admin Dashboard</a>
                            @else
        ...
        <div class="px-4 pt-4 pb-6 space-y-1">
            ...
            @auth
                <div class="pt-4 mt-2 border-t border-beige">
                    ...
                    @if(Auth::user()->isAdmin())
                        <a href="{{ route('admin.dashboard') }}" class="block text-secondary text-xs uppercase tracking-widest font-medium py-2">Admin Dashboard</a>
                    @else
